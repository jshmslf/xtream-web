...
export default function TVDetail({ params }: PageProps) {
  ...
  ])) as [TMDBShow, { cast: TMDBCastMember[] }, { results: TMDBVideo[] }, { logos: { file_path: string; iso_639_1: string }[] }]
      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '0 1.25rem 4rem', marginTop: '-80px', position: 'relative', zIndex: 2 }}>
        ...
        <div className="flex flex-col sm:flex-row gap-6 sm:gap-8">
          ...
          <div className="hidden sm:block shrink-0">
            <Image src={imgUrl(detail.poster_path)} alt={detail.name} width={200} height={300}
          ...
          <div className="flex-1 sm:pt-16">
            ...
            {logoPath ? (
              <div style={{ marginBottom: '1rem' }}>
                <Image
                  src={imgUrl(logoPath, 'w500')} alt={detail.name}
